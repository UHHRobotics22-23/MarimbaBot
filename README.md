...
# setup the environment for cuda
source YOUR_PATH/bin/activate  # fist to activate your virtual environment
bash src/marimbabot/activate_cuda.sh  # activate the cude setup, if sucessed, you will see a gpu device. 
```
